...
public class Practice01LinearGradientView extends View {
...

    {
        ...
        LinearGradient linearGradient = new LinearGradient(100f,100f,400f,400f,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(250, 200, 150, paint);


        LinearGradient linearGradient = new LinearGradient(200f,450f,400f,700f,
                Color.parseColor("#E91E63"),Color.parseColor("#2196F3"),Shader.TileMode.MIRROR);
        paint.setShader(linearGradient);
        canvas.drawCircle(250,550,150,paint);

        LinearGradient linearGradient1 = new LinearGradient(450f,300f,600f,500f,
                Color.parseColor("#E91E63"),Color.parseColor("#2196F3"),Shader.TileMode.REPEAT);
        paint.setShader(linearGradient1);
        canvas.drawCircle(600,400,150,paint);
    }
}
